...
```bash
python -m app.module_b.evaluation.run_cp4_eval --db app/data/telemetry.db --out app/module_b/docs/eval_run_summary_seed0.md
```
...
| cab | 8 | 0.14 | 0.00 | 4.46 | 4.07 | 2.17 | 0.20 |
