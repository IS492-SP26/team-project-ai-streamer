...
[Automatic LLM Red Teaming (PDF)](literatures/Automatic_LLM_Red_Teaming.pdf)
...
[Design Patterns for Securing LLM Agents against Prompt Injection (PDF)](literatures/Design Patterns for Securing LLM Agents.pdf)
